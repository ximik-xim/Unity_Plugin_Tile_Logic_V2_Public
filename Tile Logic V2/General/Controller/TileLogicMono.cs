...
public class TileLogicMono : MonoBehaviour
{
    ...
    [SerializeField]
    private LogicListTaskDKO _tileLogicGroupLogicTileDead;

    [SerializeField]
    private AbsTileSpawnTrigger _tileSpawnTrigger;

    [SerializeField]
    private LogicListTaskDKO _tileLogicGroupLogicTileSpawn;
    ...
    [SerializeField]
    private TileLogicListTaskTilePositionInfo _setPositionTile;
